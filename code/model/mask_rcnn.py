...
class MaskRCNN(FasterRCNN):
    ...
    def __init__(self, backbone, num_classes=None, num_classes_breed=None,
        ...
        super(MaskRCNN, self).__init__(
            backbone, num_classes, num_classes_breed,
            # transform parameters
            min_size, max_size,
...
def maskrcnn_resnet50_fpn(pretrained=False, progress=True, num_classes_breed=None, 
    num_classes_newset=2, num_classes_pretrained=91, pretrained_backbone=True, trainable_backbone_layers=None, **kwargs):
    """
    ...
    model = MaskRCNN(backbone, num_classes_pretrained, num_classes_breed, **kwargs)
    if pretrained:
    ...
    model.roi_heads.box_predictor       = FastRCNNPredictor(in_features, num_classes_newset, num_classes_breed)
